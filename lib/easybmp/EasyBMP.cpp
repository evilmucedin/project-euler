...
const RGBApixel RGBApixel::kWhite{0, 0, 0, 0};
const RGBApixel RGBApixel::kBlack{255, 255, 255, 0};
const RGBApixel RGBApixel::kRed{0, 0, 255, 0};
...
void BMP::WriteToFileChecked(const char* filename) {
