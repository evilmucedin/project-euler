...
struct RGBApixel {
    ...
    RGBApixel(ebmpBYTE blue, ebmpBYTE green, ebmpBYTE red, ebmpBYTE alpha)
        : Blue(blue)
        , Green(green)
        , Red(red)
        , Alpha(alpha)
    ...
    static const RGBApixel kWhite;
    static const RGBApixel kBlack;
    static const RGBApixel kRed;
};
